       ...
       <div class="p-4 bg-base-100 rounded-lg shadow-lg border">
          ...
          <div class="space-y-1">
            ...
            <div class="flex justify-around">
             <button onclick="imageContainer('${image}', '${pet_name}')" id="btn-like" class="btn bg-white border-blue-200 rounded-lg px-4 hover:border-blue-400"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
